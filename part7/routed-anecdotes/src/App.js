...
const Form = withRouter(CreateNew)
...
const App = () => {
  ...
  const showNotification = (message)=>{
    setNotification(`new anecdote "${message}" created!`)
    setTimeout(()=>{
  ...
  return (
    ...
    <Router>
      ...
      <div>
        ...
        <Route path='/create' render={()=><Form addNew={addNew} showNotification={showNotification}/>} />
