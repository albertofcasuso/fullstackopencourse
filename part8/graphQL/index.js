...
const resolvers = {
  Query: {
    ...
    allBooks: (root,args) => {
      if(args.author || args.genre){
        ...
        return args.genre?byAuthor.filter(book=>book.genres.find(genre=>genre === args.genre)):byAuthor
      }
      return books
    },
  ...
  Mutation:{
    addBook:(root,args) => {
      ...
      const authorExists = authors.find(author=>book.author === author.name)
      const newAuthor = {
        name:book.author,
        id:uuid()
      }
      authorExists?null:authors = authors.concat(newAuthor)
